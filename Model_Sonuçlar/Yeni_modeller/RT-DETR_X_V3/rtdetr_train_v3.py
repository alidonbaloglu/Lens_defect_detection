...
# ----------------------------
# Dataset yolları
YOLO_ROOT = r"C:/Users/arge.ortak/Desktop/Lens/Datasets/Lens_Kabin_Aralik_Yolo"
DATASET_YAML = r"C:/Users/arge.ortak/Desktop/Lens/Datasets/Lens_Kabin_Aralik_Yolo/data.yaml"
...
BEST_MODEL_PATH = os.path.join(MODEL_DIR, "RTDETR_kabin_aralik_BEST.pt")
LAST_MODEL_PATH = os.path.join(MODEL_DIR, "RTDETR_kabin_aralik_LAST.pt")
